        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logging is successful');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); // const stripe = await loadStripe('pk_test_51NLQKqSHnyZqmFW5EPy67uJrDFDg8FVQTIbt2VmHQ6K3eqnvoKR9RbdXc5tU7RfZrq73TUE2DXLxBcuKEe7bi7eU003su1uL7L');
...
if (userPasswordForm) userPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var passwordCurrent, password, passwordConform;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
